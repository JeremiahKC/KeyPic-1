...
public class ENVActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ENVActivity.this, WelcomeActivity.class);
        ...
        photoList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                AccessTokenManager accessTokenManager = new AccessTokenManager(ENVActivity.this);
                accessTokenManager.checkAccessTokenExpiration();
                ...
                if (folderName != null) {
                    ...
                    Toast.makeText(ENVActivity.this, "Error: Job Number/Folder is empty or invalid", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private boolean isGreenBackground(View view) {
        ...
        if (background instanceof ColorDrawable) {
            ...
            return backgroundColor == ContextCompat.getColor(ENVActivity.this, R.color.photoColor);
        }
        return false;
    }

    private void showRetakeDialog(final int position) {
        AlertDialog.Builder builder = new AlertDialog.Builder(ENVActivity.this);
    ...
    public class DriveTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result) {
                if (!createFolder) {
                    ...
                    Toast.makeText(ENVActivity.this, toastMessage, Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(ENVActivity.this, "Error: Network connection not found.", Toast.LENGTH_LONG).show();
            }
        }
        ...
        private void createFolder() {
            ProgressDialog createFolderProgressDialog = new ProgressDialog(ENVActivity.this);
        ...
        private class CreateFolderTask extends AsyncTask<Void, Void, Boolean> {
            ...
            protected void onPostExecute(Boolean result) {
                ...
                if (result) {
                    ...
                    makePhotoList();
                    check.setVisibility(View.VISIBLE);
                    Toast.makeText(ENVActivity.this, "Folder Created in 'My Drive'", Toast.LENGTH_SHORT).show();
